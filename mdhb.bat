...
rem #+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
rem #+   
rem #+     Mumps Compiler MDH Toolkit
...
rem #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
rem
rem Compile C++ programs using the MDH library
rem
cl /w /O1 /EHsc %1.cpp /I c:\mumpsc\include c:\mumpsc\lib\mumpsblib.lib \mumpsc\lib\libdb42.lib
